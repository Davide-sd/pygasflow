...
# Test for __no_check. The aim is for the parameters to make into the function
# and either produce errors or produce random junk results
...
func(ValueError, sw.normal_mach_upstream, [2, 3], None, 20, "asd") # flag is not 'weak', 'strong' or 'both'
...
# TODO: the following exception should not be raised!!!!
func(ValueError, sw.normal_mach_upstream, [2, 3], None, 20, "both") # flag is not 'weak', 'strong' or 'both'
func(ValueError, sw.get_upstream_normal_mach_from_ratio, "asd", 2) # invalid ratioName
