...
def test_1(param_name, value, er):
...
test_1("m", 3, expected_res)
test_1("pressure", 0.02722368, expected_res)
test_1("temperature", 0.35714285, expected_res)
test_1("density", 0.07622631, expected_res)
test_1("crit_area_super", 4.23456790, expected_res)
test_1("prandtl_meyer", 49.7573467, expected_res)
test_1("mach_angle", 19.4712206, expected_res)
...
test_1("m", 0.5, expected_res)
test_1("pressure", 0.84301917, expected_res)
test_1("temperature", 0.95238095, expected_res)
test_1("density", 0.88517013, expected_res)
test_1("crit_area_sub", 1.33984375, expected_res)
# no prandtl_meyer-angle and mach-angle for subsonic case
# test_1("prandtl_meyer", np.nan, expected_res)
# test_1("mach_angle", np.nan, expected_res)